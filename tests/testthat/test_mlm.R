...
expect_error(predict(mlm_mod_df_3, newdata = df_3))
df_3_noresponse <- as.data.frame(x = df_3[, "x"])
predict(mlm_mod_df_3, newdata = df_3_noresponse)
